...
struct AppTheme {
    static let options: [ThemeOption] = [
        ThemeOption(name: "blue",       nameEN: "Blue (Standard)", nameDE: "Blau (Standard)", color: Color(hex: "0077FF"), useDarkCheckmark: false),
        ...
        ThemeOption(name: "violet",     nameEN: "Violet",          nameDE: "Violett",         color: Color(hex: "7C3AED"), useDarkCheckmark: false),
